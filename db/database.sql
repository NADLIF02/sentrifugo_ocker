...
--
-- Host: localhost    Database: sentrifugodb
-- ------------------------------------------------------
...
--
-- Current Database: `sentrifugodb`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `sentrifugodb` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_agencylist_aft_upd` AFTER UPDATE ON `main_bgagencylist` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_bgchecks_summary` AFTER INSERT ON `main_bgcheckdetails` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_bgchecks_aft_update` AFTER UPDATE ON `main_bgcheckdetails` FOR EACH ROW BEGIN
					declare detailid,specimen_id, specimen_name, emp_id, specimen_flag_name, agency_name, 
						screening_type, created_name, modified_name,createdbyname,
						modifiedbyname varchar(250);
					declare	specimen_flag_id,agency_id,screeningtype_id int(11);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_screeningtype_aft_upd` AFTER UPDATE ON `main_bgchecktype` FOR EACH ROW BEGIN
...
INSERT INTO `main_businessunits` VALUES (0,'No Business Unit','000',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,1,1,'2013-12-04 18:51:19','2013-12-04 18:51:19',1);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_businessunits_main_requisition_summary` AFTER UPDATE ON `main_businessunits` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_candidates_aft_upd` AFTER UPDATE ON `main_candidatedetails` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_cities_aft_upd` AFTER UPDATE ON `main_cities` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_countries_aft_upd` AFTER UPDATE ON `main_countries` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_departments_main_requisition_summary` AFTER UPDATE ON `main_departments` FOR EACH ROW BEGIN
...
CREATE TABLE `main_empadditionaldetails` (
  ...
  `from_date` date DEFAULT NULL,
  `to_date` date DEFAULT NULL,
  `special_training` text DEFAULT NULL,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_employeeleavetypes_aft_upd` AFTER UPDATE ON `main_employeeleavetypes` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_employees_aft_ins` AFTER INSERT ON `main_employees` 
				    FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_employees_aft_upd` AFTER UPDATE ON `main_employees` 
				    FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_employmentstatus_main_requisition_summary` AFTER UPDATE ON `main_employmentstatus` FOR EACH ROW BEGIN
...
CREATE TABLE `main_exit_process` (
  ...
  `employee_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `overall_status` enum('Pending','Approved','Rejected') COLLATE utf8mb3_unicode_ci DEFAULT 'Pending',
  `overall_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `l1_status` enum('Pending','Approved','Rejected') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `l1_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `l2_status` enum('Pending','Approved','Rejected') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `l2_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `hr_manager_status` enum('Pending','Approved','Rejected') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `hr_manager_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sys_admin_status` enum('Pending','Approved','Rejected') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `sys_admin_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `gen_admin_status` enum('Pending','Approved','Rejected') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `gen_admin_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `fin_admin_status` enum('Pending','Approved','Rejected') COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `fin_admin_comments` varchar(1000) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
CREATE TABLE `main_exit_questions_response` (
  ...
  `hr_qs` text COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `employee_response` text COLLATE utf8mb3_unicode_ci DEFAULT NULL COMMENT '{hr_qs_id_1:emp_comments,hr_qs_id_2:emp_comments}',
  `createdby` int(11) NOT NULL,
  `modifiedby` int(11) DEFAULT NULL,
  `createddate` datetime NOT NULL,
  `modifieddate` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
CREATE TABLE `main_exit_types` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `exit_type` varchar(50) COLLATE utf8mb3_unicode_ci NOT NULL,
  `description` varchar(255) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
  `createdby` int(11) NOT NULL,
  `modifiedby` int(11) DEFAULT NULL,
  `createddate` datetime NOT NULL,
...
INSERT INTO `main_exit_types` VALUES (1,'Resign','Resign',1,1,'2021-08-19 16:56:56','2021-08-19 16:56:56',1,0),(2,'Transfer','Transfer',1,1,'2021-08-19 16:56:56','2021-08-19 16:56:56',1,0),(3,'Retirement','Retirement',1,1,'2021-08-19 16:56:56','2021-08-19 16:56:56',1,0);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_holidaygroups_aft_ins` AFTER UPDATE ON `main_holidaygroups` FOR EACH ROW BEGIN
...
INSERT INTO `main_identitycodes` VALUES (1,'EMPP','BGCK','','','USER','REQ',1,'2015-03-05 11:46:44',1,'2015-03-05 11:46:44');
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_identitycodes_aft_upd` AFTER UPDATE ON `main_identitycodes` 
				    FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_interviewdetails_aft_upd` AFTER UPDATE ON `main_interviewdetails` FOR EACH ROW BEGIN
...
CREATE TABLE `main_interviewrounddetails` (
  ...
  `interview_comments` text DEFAULT NULL,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_interviewrounddetails_aft_ins` AFTER INSERT ON `main_interviewrounddetails` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_interviewrounddetails_aft_upd` AFTER UPDATE ON `main_interviewrounddetails` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_jobtitles_aft_upd` AFTER UPDATE ON `main_jobtitles` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_leavemanagement_aft_ins` AFTER INSERT ON `main_leavemanagement` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_leavemanagement_aft_upd` AFTER UPDATE ON `main_leavemanagement` FOR EACH ROW BEGIN
				    declare calmonth_name,weekend_name1,weekend_name2,dept_name,buss_unit_name varchar(200);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_leaverequest_aft_ins` AFTER INSERT ON `main_leaverequest` 
					FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_leaverequest_aft_upd` AFTER UPDATE ON `main_leaverequest` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_monthlist_aftr_upd` AFTER UPDATE ON `main_monthslist` FOR EACH ROW BEGIN
...
CREATE TABLE `main_pa_employee_ratings` (
  ...
  `manager_response` text DEFAULT NULL COMMENT '{''Q1'':{''Comment'':''good'',''Rating'':''rating_id''},''Q2'':{''Comment'':''excellent'',''Rating'':''rating_id''}}',
  `skill_response` text DEFAULT NULL COMMENT '{''skill_id'':''rating_id''}',
  ...
  `line_comment_1` text DEFAULT NULL COMMENT '{''rating_id'':''comment''}',
  `line_comment_2` text DEFAULT NULL COMMENT '{''rating_id'':''comment''}',
  `line_comment_3` text DEFAULT NULL COMMENT '{''rating_id'':''comment''}',
  `line_comment_4` text DEFAULT NULL,
  `line_comment_5` text DEFAULT NULL,
...
CREATE TABLE `main_pa_ff_initialization` (
  ...
  `qs_privileges` text DEFAULT NULL,
...
CREATE TABLE `main_pa_manager_initialization` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `pa_initialization_id` bigint(20) unsigned DEFAULT NULL,
  `selected_employee_ids` text DEFAULT NULL COMMENT 'Comma separated employee ids selected during initialization',
...
CREATE TABLE `main_pa_questions_privileges` (
  ...
  `hr_group_qs_privileges` text DEFAULT NULL COMMENT '{''Q1'':{''Manager Comments'':1,''Employee Comments'':1,''Manager Ratings'':1,''Employee Ratings'':1}}',
  `manager_group_id` bigint(20) unsigned DEFAULT NULL COMMENT 'group id of employees created by manager',
  `manager_qs` text DEFAULT NULL COMMENT 'Comma separeated question ids created by manager',
  `manager_qs_privileges` text DEFAULT NULL COMMENT '{''Q1'':{''Manager Comments'':1,''Employee Comments'':1,''Manager Ratings'':1,''Employee Ratings'':1}}',
  `ff_qs` text DEFAULT NULL COMMENT 'Comma separeated question ids created by management',
  `ff_qs_privileges` text DEFAULT NULL COMMENT '{''Q1'':{''Employee Comments'':1,''Employee Ratings'':1}}',
...
INSERT INTO `main_patches_version` VALUES (1,'3.2','2021-08-19 16:57:10','2021-08-19 16:57:10',1);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_positions_main_requisition_summary` AFTER UPDATE ON `main_positions` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_prefix_aft_upd` AFTER UPDATE ON `main_prefix` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_requisition_aft_ins` AFTER INSERT ON `main_requisition` 
					FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_requisition_aft_upd` AFTER UPDATE ON `main_requisition` 
					FOR EACH ROW BEGIN
...
CREATE TABLE `main_requisition_history` (
  ...
  `candidate_name` varchar(150) COLLATE utf8mb3_unicode_ci DEFAULT NULL,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_roles_aft_upd` AFTER UPDATE ON `main_roles` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_sd_depts_aft_upd` AFTER UPDATE ON `main_sd_depts` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_sd_reqtypes_aft_upd` AFTER UPDATE ON `main_sd_reqtypes` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_sd_request_aft_ins` AFTER INSERT ON `main_sd_requests` 
					FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_sd_request_aft_upd` AFTER UPDATE ON `main_sd_requests` 
					FOR EACH ROW BEGIN
					DECLARE x_service_desk_name,x_service_request_name,x_raised_by_name,x_executor_name,
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_states_aft_upd` AFTER UPDATE ON `main_states` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_users_aft_upd` AFTER UPDATE ON `main_users` 
				    FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`sentrifugo`@`%`*/ /*!50003 TRIGGER `main_weekdays_aftr_upd` AFTER UPDATE ON `main_weekdays` FOR EACH ROW BEGIN
...
INSERT INTO `main_wizard` VALUES (1,1,1,1,1,1,NULL,NULL,NULL,1,NULL,NULL,NULL,NULL,NULL);
...
-- Dump completed on 2021-08-19 18:50:00
